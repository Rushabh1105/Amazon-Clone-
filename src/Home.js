  ...
  return (
    <div className='home' >
        <div className="home__container">
            ...
            <div className="home__row">
                <Product id='3' title='Apple Iphone 14 Pro' price={12299} image="https://s13emagst.akamaized.net/products/48592/48591224/images/res_c5366b309c505a8dc1361685a1c2ed9d.jpg" rating={5} />
